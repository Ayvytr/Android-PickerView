...
import com.bigkoo.custompickerview.listener.OnDismissListener;
import com.bigkoo.custompickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.layout_custom_basepickerview, null, false);
            //设置界面的背景为透明
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.layout_custom_basepickerview, mPickerOptions.decorView, false);
