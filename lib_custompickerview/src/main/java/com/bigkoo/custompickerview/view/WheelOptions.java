...
public class WheelOptions<T> {
    private View view;
    private CustomWheelView wv_option1;
    private CustomWheelView wv_option2;
    private CustomWheelView wv_option3;
    ...
    public WheelOptions(View view, boolean isRestoreItem) {
        ...
        this.view = view;
        wv_option1 = (CustomWheelView) view.findViewById(R.id.options1);// 初始化时显示的数据
        wv_option2 = (CustomWheelView) view.findViewById(R.id.options2);
        wv_option3 = (CustomWheelView) view.findViewById(R.id.options3);
    }
