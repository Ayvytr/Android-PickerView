package com.bigkoo.custompickerview.configure;
...
import com.bigkoo.custompickerview.listener.OnOptionsSelectChangeListener;
import com.bigkoo.custompickerview.listener.OnOptionsSelectListener;
...
public class PickerOptions {
    ...
    public boolean isRangeAccurate;


    public PickerOptions(int buildType) {
        if (buildType == TYPE_PICKER_OPTIONS) {
            layoutRes = R.layout.custompickerview_options;
        } else {
            layoutRes = R.layout.custom_pickerview_time;
        }
    }
    ...
    public CustomWheelView.DividerType dividerType = CustomWheelView.DividerType.FILL;//分隔线类型
